    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PasswordHash = table.Column<string>(type: "varchar(500)", maxLength: 500, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    PasswordAlgorithm = table.Column<int>(type: "int", nullable: false),
                    IsActive = table.Column<bool>(type: "tinyint(1)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_user_applications", x => new { x.UserId, x.ApplicationId });
                    table.ForeignKey(
                        name: "FK_user_applications_applications_ApplicationId",
                        column: x => x.ApplicationId,
                        principalTable: "applications",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_user_applications_users_UserId",
                        column: x => x.UserId,
                        principalTable: "users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_password_reset_tokens_UserId_IsUsed",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_sessions_IsRevoked_AbsoluteExpiration",
                table: "sessions",
                columns: new[] { "IsRevoked", "AbsoluteExpiration" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_user_applications_ApplicationId",
